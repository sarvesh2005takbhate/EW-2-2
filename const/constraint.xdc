...
# Team indicator LEDs (Optional - you can use onboard LEDs to show current team)
# set_property PACKAGE_PIN F22 [get_ports {current_team[1]}];  # "LD8" if available
# set_property PACKAGE_PIN G22 [get_ports {current_team[0]}];  # "LD9" if available
...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN P16 [get_ports {rst}];  # "BTNM" - Center button for reset
set_property PACKAGE_PIN T18 [get_ports {up}];  # "BTNU" - Up button for navigation
set_property PACKAGE_PIN R18 [get_ports {right}];  # "BTNR" - Right button for navigation
set_property PACKAGE_PIN N15 [get_ports {left}];  # "BTNL" - Left button for navigation
set_property PACKAGE_PIN R16 [get_ports {down}];  # "BTND" - Down button for navigation
