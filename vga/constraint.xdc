...
set_property PACKAGE_PIN T18 [get_ports {up}];  # "BTNU"
set_property PACKAGE_PIN R18 [get_ports {right}];  # "BTNR"
set_property PACKAGE_PIN N15 [get_ports {left}];  # "BTNL
set_property PACKAGE_PIN R16 [get_ports {down}];  # "BTND"
